...
class HybridUnet(nn.Module):
    def __init__(self, output,rec_down_convs,rec_up_convs,down_convs,up_convs):
        ...
        in_channel = self.rec_down_channel[-1]
    ...
    #         fe = self.maxpool(fe)
        ...
        print(meshes[0].image.shape) #should be in the form of [batch,channel,height,width]
    ...
    def forward(self, meshes):
        ...
        for idx,mesh in enumerate(meshes):     
            ...
            if self.pool is not None:
                ...
                mesh.update_dictionary(edge_attribute,"edge_feature")
            mesh.image = v_f
